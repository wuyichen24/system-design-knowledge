...
| Cache stampede (Thundering herd) | <li>Cache misses on popular items<li>A sudden spike in user traffic<li>Service restarts after maintenance | A sudden influx of requests overwhelms the system | Same as above |
