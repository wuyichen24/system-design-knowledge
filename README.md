...
| [*Leader Election*](patterns/container_patterns/Leader_Election.md) | ![](./diagrams/png/leader_election_small.png) | <ul><li>Elect one container as the leader for coordinating and monitoring the other containers.</ul> |
