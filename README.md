...
| [*Try-Confirm/Cancel (TCC)*](patterns/transaction_patterns/Try_Confirm_Cancel.md) | | <li>Use 2 phases (try phase and confirm) to change the state of a record.<li>Add an intermediate state (pending state or reserved state) in the middle of those 2 phases. |
