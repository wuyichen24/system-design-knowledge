...
- [**Indexing**](components/database/Database_Indexing.md)
   ...
   - [Data structure](components/database/Database_Indexing.md#data-structure)
      - [B-tree](components/database/Database_Indexing.md#b-tree)
      - [B+ tree](components/database/Database_Indexing.md#b-tree-1)
      - [Comparison between B-tree and B+ tree](components/database/Database_Indexing.md#comparison-between-b-tree-and-b-tree)
   - [Main categories](components/database/Database_Indexing.md#main-categories)
      - [Clustered index](components/database/Database_Indexing.md#clustered-index)
      - [Non-clustered index](components/database/Database_Indexing.md#non-clustered-index)
      - [Comparison between clustered index and non-clustered index](components/database/Database_Indexing.md#comparison-between-clustered-index-and-non-clustered-index)
   - [Types](components/database/Database_Indexing.md#types)
      - [Primary index](components/database/Database_Indexing.md#primary-index)
      - [Secondary index](components/database/Database_Indexing.md#secondary-index)
      - [Composite index](components/database/Database_Indexing.md#composite-index)
      - [Covering index](components/database/Database_Indexing.md#covering-index)
      - [Unique index](components/database/Database_Indexing.md#unique-index)
      - [Filter index](components/database/Database_Indexing.md#filter-index)
      - [Bitmap index](components/database/Database_Indexing.md#bitmap-index)
      - [Spatial index](components/database/Database_Indexing.md#spatial-index)
      - [Full-text index](components/database/Database_Indexing.md#full-text-index)
      - [Hash index](components/database/Database_Indexing.md#hash-index)
