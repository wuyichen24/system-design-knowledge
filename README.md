...
| [*Try-Confirm/Cancel (TCC)*](patterns/transaction_patterns/Try_Confirm_Cancel.md) | ![](./diagrams/png/tcc_small.png) | <li>Use 2 phases (try-phase and confirm-phase) to change a state.<li>Add an intermediate state (pending state or reserved state) in the middle of those 2 phases. |
