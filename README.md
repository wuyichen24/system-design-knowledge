...
- [**Database (DB)**](components/Database.md)
   - [Types](components/Database.md#types)
      - [Overview](components/Database.md#overview)
      - [Details of main types](components/Database.md#details-of-main-types)
         - [Relational databases](components/Database.md#relational-databases)
         - [NoSQL databases](components/Database.md#nosql-databases)
   ...
   - [Techniques](components/Database.md#techniques)
      ...
      - [Denormalization (Materialized View)](components/Database.md#denormalization-materialized-view)
