...
| Pattern Name | Diagram | Description |
| ---- | ------ | ---- |
| [*Circuit Breaker*](patterns/resiliency_patterns/Circuit_Breaker.md) |  | Detects failures and prevents the application from trying to perform the action that is doomed to fail. |
